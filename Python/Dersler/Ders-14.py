...
# print(type(datetime.date.today()))#Tipi <class 'datetime.date'> dir.

# print(datetime.date.today())#Bu gunu verir

# print(datetime.date.today().day)#bu gunku gunu verir 
...
allStudent = {
    "cavid@gmail.com":{
        ...
        "created_at":datetime.date.fromisoformat("2022-03-01")
    ...
    "elsad@gmail.com":{
        ...
        "created_at":datetime.date.fromisoformat("2022-02-10")
    }
}
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
while True:
    ...
    if select == "1":
        ...
        if co != 1:
            ...
            if len(ad)>=3 and len(soyad)>=3 and len(ata)>=3 and dogumili <= 2004 and dogumili >= 1990:
                ...
                "qrup":qrup,
                "email":mail,
                "created_at": datetime.date.fromisoformat(muddet)}})
            else:
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        daxil = input("Telebenin emailini daxil edin : ")
        for i in allStudent:
            if i == daxil:
                mar = int(input("Qiymet daxil edin : "))
                if mar > 0 and mar < 13:
                    allStudent.update({"mark":mar})
                else:
                    print("Daxil edilmis eded minimum 1 maksimum 12 ola biler !")
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        for t in allStudent.values():
            ...
            if t["email"] == dail:
                qosulma = datetime.date.today() - t["created_at"]
