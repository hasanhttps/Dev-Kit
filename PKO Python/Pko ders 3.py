# if -->> budqlanan alqoritmin qurulmasi ucundur.
...
# if 18 % 6 != 0:
#     print("Test 3")
# login = "hasanabdullazad'gmail.com"
# password = "200Hasan"

# login_daxil = input("Emailinizi daxil edin : ")

# password_daxil = input("Kodunuzu daxil edin : ")

# if login == login_daxil:
#     if password_daxil == password:
#         print("Welcome")
#     else:
